document.addEventListener('DOMContentLoaded', () => {
  const MD_PATH  = 'https://raw.githubusercontent.com/Kasei1/workout/main/program.md'; // markdown file
  ...
  document.querySelectorAll('.open-md')
          .forEach(btn => btn.addEventListener('click', openMarkdown));
